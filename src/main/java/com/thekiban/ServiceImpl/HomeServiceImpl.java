...
public class HomeServiceImpl implements HomeService {
  ...
  @Override
  public List<SampleOutcome> SelectOutcomeList() {return mapper.SelectOutcomeList();}

  @Override
  public List<SampleOutcome> SearchOutcome(String sample_name) {
    return mapper.SearchOutcome(sample_name);
  }
