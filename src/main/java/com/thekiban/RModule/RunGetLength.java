...
public class RunGetLength {
          
	public  void MakeRunGetLength(String jobid,  String inputfile) {
	...
	//public static void main(String[] args) {
		...
		String cmd = "infoseq "+ work_dir+inputfile + " | awk '{print $3,$6}' > " + work_dir+"lengh.len";
